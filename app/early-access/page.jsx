  ...
  return (
    <main className="relative min-h-screen overflow-hidden bg-black font-montserrat">
      ...
      <section className="relative z-10 flex min-h-screen flex-col items-center justify-center px-4 text-center sm:px-6">
        ...
        >
          Historical intelligence for the physical world. Leave your email for early access.
        </motion.p>
        ...
        <motion.p
          ...
          className="mt-6 text-[11px] font-medium uppercase tracking-[0.22em] text-white/50 sm:text-xs"
        >
      ...
      <section className="relative z-10 flex min-h-screen flex-col items-center justify-center px-6 py-24 text-center sm:px-10">
        ...
        >
          ...
          <p className="mt-7 text-base leading-relaxed text-white/65 sm:text-lg">
            Heritage is fading faster than we can witness it. The world&apos;s monuments stand
            weathered and incomplete — their stories flattened into plaques and guesswork, a
            fraction of the wonder they once were.
          </p>
          <p className="mt-5 text-base leading-relaxed text-white/65 sm:text-lg">
            Epocheye is historical intelligence for the physical world. Point your phone at a
            monument and watch it rise again in augmented reality — rebuilt in its original
            glory, with an AI historian narrating exactly where you stand. Our mission is to
            make heritage something you <span className="text-white">experience</span>, not
            just read about: bridging centuries of history with technology so the world&apos;s

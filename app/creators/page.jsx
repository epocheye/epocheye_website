...
export default function CreatorsLandingPage() {
	return (
		<main className="bg-black min-h-screen font-montserrat text-white overflow-x-hidden relative">
				...
				<section className="relative min-h-screen flex flex-col items-center justify-center text-center px-6 pt-24 pb-20 overflow-hidden">
					...
					<motion.div
						...
						<motion.p
							...
							Promote Epocheye to your audience using your unique promo code.
							Every signup earns you a commission — no content restrictions, no
							approval required.
						</motion.p>
					...
					<div className="grid md:grid-cols-3 gap-px bg-white/5">
						{STEPS.map((step, i) => (
							<motion.div
								...
								<span className="text-5xl font-bold text-white/8 leading-none">
									{step.number}
								</span>
								<div>
					...
					<div className="max-w-6xl mx-auto">
						<motion.div
							...
							<h2 className="text-3xl md:text-4xl lg:text-5xl font-light leading-tight">
								Commission ranges{" "}
								<span className="font-bold">5% to 20%</span>
							</h2>
							<p className="mt-4 text-white/40 max-w-lg">
								Based on Epocheye&apos;s $2–4/month subscription. Bring more
								signups, unlock a higher commission tier.
							</p>
						</motion.div>
					...
					<div className="max-w-6xl mx-auto grid md:grid-cols-2 gap-16 items-center">
						<motion.div
							...
							<p className="text-white/50 leading-relaxed max-w-md">
								Instagram reels, YouTube reviews, TikTok tours, blog posts,
								Twitter threads — if it reaches an audience, it works. We
								track by promo code, not platform.
							</p>
						</motion.div>
					...
					<div className="max-w-6xl mx-auto">
						<motion.div
							...
							<h2 className="text-3xl md:text-4xl lg:text-5xl font-light">
								Track every click,{" "}
								<span className="font-bold">every rupee</span>
							</h2>
						</motion.div>

  ...
  return (
    <div className="min-h-screen bg-[#0A0A0A] relative overflow-hidden font-montserrat">
      ...
      <motion.nav
        ...
        <Link href="/creators" className="text-lg font-bold tracking-wider text-white">
          Epocheye <span className="text-white/30 font-normal text-sm ml-1">/ Creators</span>
        </Link>
        <Link
          href="/creators"
        ...
        <motion.div
          ...
          <div className="text-center mb-8">
            ...
            <p className="text-white/40 mt-3 text-sm tracking-wide">
              {step === 1 ? "Create your account" : "Tell us about your content"}
            </p>
                ...
                {step === 1 ? (
                  ...
                  <motion.form
                    ...
                    <Field label="TikTok URL" htmlFor="tt">
                      <div className="relative group">
                        <span className="absolute left-4 top-1/2 -translate-y-1/2 text-white/25 text-xs font-bold">T</span>
                        <input
                          id="tt"
                          type="url"
                    ...
                    <Field label="Content Niche" htmlFor="niche">
                      <div className="relative group">
                        <select
                          ...
                          <option value="" className="bg-black">Select a niche…</option>
                          {NICHES.map((n) => (

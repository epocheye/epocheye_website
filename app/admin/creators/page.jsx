            ...
            <table className="w-full text-sm">
              <thead>
                <tr className="border-b border-white/5">
                  ...
                  <th className="hidden sm:table-cell px-5 py-3 text-left text-xs text-white/35 font-medium">Email</th>
                  <th className="px-5 py-3 text-left text-xs text-white/35 font-medium">Code</th>
                  <th className="hidden md:table-cell px-5 py-3 text-center text-xs text-white/35 font-medium">Commission</th>
                  <th className="hidden md:table-cell px-5 py-3 text-center text-xs text-white/35 font-medium">Discount</th>
                  <th className="px-5 py-3 text-center text-xs text-white/35 font-medium">Status</th>
                  <th className="hidden lg:table-cell px-5 py-3 text-right text-xs text-white/35 font-medium">Joined</th>
              ...
              <tbody>
                {creators.map((c) => (
                  <tr
                    ...
                    <td className="hidden sm:table-cell px-5 py-3 text-white/40 text-xs">{c.email}</td>
                    <td className="px-5 py-3 font-mono text-white/50 text-xs">
                      {c.promo_code ?? <span className="text-white/20">—</span>}
                    </td>
                    <td className="hidden md:table-cell px-5 py-3 text-center text-white/60">{c.commission_rate}%</td>
                    <td className="hidden md:table-cell px-5 py-3 text-center text-white/60">{c.customer_discount}%</td>
                    <td className="px-5 py-3 text-center">
                      <StatusBadge status={c.status} />
                    </td>
                    <td className="hidden lg:table-cell px-5 py-3 text-right text-white/30 text-xs">

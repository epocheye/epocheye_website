		...
		<section className="relative w-full bg-ink overflow-hidden">
			...
			<MouseParallax className="px-6 sm:px-10 pt-28 pb-16 lg:min-h-[90vh] lg:flex lg:flex-col lg:justify-center tw-3d">
				...
				<div className="hidden lg:flex items-start justify-between absolute top-10 left-10 right-10">
					<span className="mono-label text-xs text-bone-muted" data-depth="14">Epocheye — Est. 2026</span>
					<span className="mono-label text-xs text-bone-muted text-right leading-relaxed" data-depth="14">
				...
				<div className="grid lg:grid-cols-[1.4fr_0.9fr] gap-10 items-center">
					...
					<div className="flex flex-col tw-3d" data-depth="26" data-ry="6" data-rx="4">
						<KineticText
							text="SEE"
							as="h2"
							split="char"
							...
							style={{ fontSize: "clamp(60px, 12vw, 168px)", lineHeight: 0.86 }}
						/>
						<KineticText
							text="THROUGH"
							as="h2"
							...
							style={{ fontSize: "clamp(48px, 10vw, 168px)", lineHeight: 0.86 }}
						/>
						<KineticText
							text="TIME."
							as="h2"
			...
			<Marquee className="relative z-10 bg-signal border-y border-ink/20" baseDuration={22}>
				<MarqueeRow />
			</Marquee>
		</section>
	);

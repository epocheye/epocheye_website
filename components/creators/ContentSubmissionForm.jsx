    ...
    <div
      ...
      <motion.div
        ...
        {done ? (
          ...
          <>
            <h2 className="text-lg font-semibold text-white mb-6">Submit Content</h2>
            ...
            <form onSubmit={handleSubmit} className="space-y-5">
              ...
              <div className="space-y-2">
                <label className={labelCx}>Title / Caption (optional)</label>
                <input
                  type="text"
                  value={form.title}
                  onChange={set("title")}
              ...
              <button
                ...
                {isLoading ? <Loader2 className="w-4 h-4 animate-spin" /> : "Submit Content"}
              </button>
            </form>
          </>
        )}

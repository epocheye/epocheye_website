  ...
  return (
    <div className="flex flex-col h-full">
      ...
      <div className="px-6 py-6 border-b border-white/5">
        <Link href="/creators" className="flex items-center gap-2.5">
          <span className="text-base font-bold text-white tracking-wider">Epocheye</span>
      ...
      <div className="px-3 pb-5 border-t border-white/5 pt-4 space-y-1">
        <div className="flex items-center gap-3 px-3 py-2.5 rounded-lg">
          ...
          <div className="min-w-0">
            <p className="text-sm font-medium text-white truncate">{creator?.name ?? "Creator"}</p>
  ...
  return (
    <>
      ...
      <div className="md:hidden fixed top-0 left-0 right-0 z-50 flex items-center justify-between px-4 py-3 border-b border-white/5 bg-[#080808]/95 backdrop-blur-md">
        <Link href="/creators" className="text-sm font-bold text-white tracking-wider">
          Epocheye <span className="text-white/30 font-normal">/ Creators</span>
        </Link>
        <button

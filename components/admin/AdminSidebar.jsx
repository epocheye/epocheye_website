...
const NAV = [
  ...
  { href: "/admin/creator-applications", label: "Creator applications", icon: UserCheck },
  { href: "/admin/creator-sites", label: "Creator sites", icon: MapPinned },
  { href: "/admin/users", label: "Users", icon: UserCircle },
  { href: "/admin/payouts", label: "Payouts", icon: Wallet },
  { href: "/admin/content", label: "Content", icon: FileText },
  { href: "/admin/sites", label: "Sites", icon: Landmark },
